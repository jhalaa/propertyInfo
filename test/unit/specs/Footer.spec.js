...
describe('Footer.vue', () => {
  ...
  it('should have 3 sections', () => {
    const Constructor = Vue.extend(Footer)
    const vm = new Constructor().$mount()
    expect(vm.$el.children[0].querySelectorAll('div').length)
      .to.equal(3)
  })
  ...
  it('should have first section about', () => {
    const Constructor = Vue.extend(Footer)
    const vm = new Constructor().$mount()
    expect(vm.$el.children[0].querySelectorAll('div')[0].textContent)
      .to.equal('About')
  })
  ...
  it('should have second section contact us', () => {
    const Constructor = Vue.extend(Footer)
    const vm = new Constructor().$mount()
    expect(vm.$el.children[0].querySelectorAll('div')[1].textContent)
      .to.equal('Contact Us')
  })
  ...
  it('should have third section social media', () => {
    const Constructor = Vue.extend(Footer)
    const vm = new Constructor().$mount()
    expect(vm.$el.children[0].querySelectorAll('div')[2].textContent)
